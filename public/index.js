...
(function () {
  ...
  var createAssistWorker = function () {
      // 收集所有的worker脚本
      var workers = [];
      // 收集所有脚本需要的变量
      ...
      var execute = function (func) {
          ...
          worker.onmessage = function (e) {
              ...
              switch (data.action) {
                  case 'request': {
                      var func_1 = (_a = variables.get(data.id)) === null || _a === void 0 ? void 0 : _a.value;
                      if (func_1) {
                          var result = func_1.apply(func_1, data.arguments);
                          worker.postMessage({
                              type: data.action,
                              id: data.id,
                              value: result
                  ...
                  case 'callback': {
                      var _b = workers[data.id], worker_1 = _b.worker, done = _b.done, scriptBlobURL = _b.scriptBlobURL;
          ...
          return function () {
              ...
              return new Promise(function (resolve, reject) {
                  ...
                  worker.postMessage({ id: id, action: 'init', arguments: args });
              });
          };
      };
      var worker = {
          collect: function (data) {
              for (var key in data) {
                  ...
                  if (type === 'function')
                      ...
                      variables.set(key, { type: type, value: value });
              }
              return worker;
          },
  ...
  var main = function () {
      ...
      var b = 'b_Value';
      var c = 'c_Value';
      var d = function (suffix) {
          console.log('d_Value');
          return c + suffix;
      };
      var worker = assistWorker
          .collect({ a: a, b: b })
          .request({ d: d })
          .execute(function () {
